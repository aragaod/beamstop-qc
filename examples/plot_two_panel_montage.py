...
a two-panel analysis montage (2D beam center + 1D profile).
"""
...
OUTPUT_FILE = OUTPUT_DIR / 'two_panel_montage_example.png'
...
def main():
    ...
    logging.info("--- Running Two-Panel Montage Example ---")
    ...
    cli_options = {
        'montage_type': 'vertical', # Creates a 2-panel plot with the vertical profile
        'vertical_up': False,
